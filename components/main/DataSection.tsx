...
const DataSection: FC<DataSectionProps> = ({
    ...
    switch (heading) {
        case 'Projects':
            if (userProfileData) {
                dataBox = (
                    <FilledProjectList userProfileData={userProfileData} />
                ); //need to add prop of user profile data
        ...
        case 'Experience':
            if (userProfileData) {
                dataBox = (
                    <FilledExperienceList userProfileData={userProfileData} />
                );
        ...
        case 'About':
            if (userProfileData) {
                dataBox = (
                    <FilledAboutSection userProfileData={userProfileData} />
                );
